                        ...
                        {mode === 'agent-lab' ? (
                          <div className="mt-3 rounded-[16px] border border-[#D7E1DD] bg-white/78 px-3 py-2">
                            ...
                            <p className="mt-2 text-[11px] leading-relaxed text-[#5C7069]">
                              Structured board tools only: graphs, points and tables, algebra steps, geometry, number lines, fraction bars, and short labels or highlights.
                            </p>
                          </div>
                        ) : null}
                      </div>
                  ...
                  <div className="mt-3 space-y-3">
                    {!session.isConnected ? (
                      <div className="rounded-[22px] border border-[#DCE7E2] bg-white/72 px-4 py-4 text-sm leading-relaxed text-[#5C7069]">
                        {mode === 'agent-lab'
                          ? 'Start with mic for full voice tutoring, or start without mic to test typed prompts, board writing, graphs, number lines, fraction bars, and other structured math tools. The lab can teach on the board, but it does not free-sketch arbitrary drawings.'
