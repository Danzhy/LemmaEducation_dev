...
assertIncludes(canvasPdf, "pdfjs-dist/legacy/build/pdf.mjs")
assertIncludes(canvasPdf, 'createCanvasPdfExportSlices')
assertIncludes(canvasPdf, 'CANVAS_PDF_EXPORT_MAX_PAGES = 12')
...
assertIncludes(tutorWorkspace, 'pdfToolsEnabled')
